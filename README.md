...
To setup 'Coding Convergence' first open the file entitled 'Coding_Convergence_Final.json' and download the .JSON file. Next sign into TunePad, go to 'My Tunes', select import and import the .JSON file. Now it is ready to be played. 
